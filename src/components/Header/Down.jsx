...
export default function Down () {
  return (
    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      viewBox="0 0 55.751 55.751" style={{enableBackground: 'new 0 0 55.751 55.751'}} xmlSpace="preserve" width={10} height={10}>
      <g>
        <path fill="#6D033F" d="M31.836,43.006c0.282-0.281,0.518-0.59,0.725-0.912L54.17,20.485c2.107-2.109,2.109-5.528,0-7.638
