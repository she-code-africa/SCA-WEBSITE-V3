...
const HomePageModal = ({ closeModal }) => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0  z-30 bg-black/50 flex items-center justify-center py-5 overflow-auto">
      <section className="w-[90%] mx-auto max-w-[1040px] rounded-3xl md:rounded-[50px] flex items-center overflow-hidden">
        <div className="w-full flex">
          <div className="w-full bg-[#FFF88F] px-10 py-9 md:py-11 md:px-12 xl:px-20 xl:py-[70px]">
            ...
            <h3 className="text-primary-main-pink font-semibold text-[36px] md:text-[64px] hero-text">
          ...
          {/*  */}
          <div className="w-full hidden lg:block max-w-[505px]  popup-bg ">
