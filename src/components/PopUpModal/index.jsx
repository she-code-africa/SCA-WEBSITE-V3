          ...
          <div className="relative bg-white rounded-lg shadow modal-body">
            <div className="flex justify-between items-start p-5 rounded-t close-div">
              <button
                onClick={() => closeModal()}
                type="button"
                className="close text-gray-500 bg-transparent bg-gray-200 rounded-full text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
            ...
            <div className="space-y-5">
              ...
              <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                Did you know by donating as little as $5.3(~3,000 NGN), you&apos;d be helping us
