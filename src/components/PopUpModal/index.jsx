                ...
                <div className="modal-content shadow-black">
                    <div className="relative bg-white rounded-lg shadow modal-body">
                        <div className="flex justify-between items-start p-5 rounded-t close-div">
                            <button onClick={() => closeModal()} type="button" className="close text-gray-500 bg-transparent bg-gray-200 rounded-full text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white focus:outline-none focus:ring focus:ring-tutu" data-modal-toggle="defaultModal" autoFocus>
                        ...
                        <div className="flex items-center space-x-2 rounded-b justify-center">
                            <Link to="/donate-partner" data-modal-toggle="defaultModal" type="button" className="btn shecode_button focus:outline-none focus:ring-8 focus:ring-tutu">Make Donation</Link>
                        </div>
                    </div>
                </div>
            </div>
