...
const index = ({display, toggleModal, type }) => {
  ...
  return display ? 
  <div tabIndex="-1" aria-hidden="true" className="modal overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 justify-center items-center h-modal h-full md:inset-0 bg-[#333] bg-opacity-70" onClick={()=>toggleModal()}>
              ...
              <div className="relative bg-white rounded-lg shadow modal-body mt-5">
                    ...
                    <div className="modal-body p-4">
                        <div className="flex justify-between">
                            ...
                            <div>
                                <div className="box filter-button" data-filter="wire" role="button" onClick={()=> displayTransferDets()}>
                            ...
                            <div style={ transferDetails ? { display: 'block'} : {display: 'none'}}>
                                {
                                    ...
                                    <div key={index}>
                                        <div className="filter wire" >
                                            <h5 className="text-center animate__animated animate__slideInLeft"><b>{heading}</b><br/><span>{sub}</span></h5>
                                            <div className="acct-details">
                                                <div className="-mx-4 flex justify-between">
                                                    <div className="w-4/12 px-2 inline">
                                                        <p className="mini-title animate__animated animate__slideInLeft">Bank Name:</p>
                                                    </div>
                                                    <div className="w-8/12 inline">
                                                        <p className="mini-title animate__animated animate__slideInLeft font-extrabold">{acct_details.bank_name}</p>
                                                    </div>
                                                </div>
                                                <div className="-mx-4 flex justify-between">
                                                    <div className="w-4/12 px-2">
                                                        <p className="mini-title animate__animated animate__slideInLeft">Bank Account Name:</p>
                                                    </div>
                                                    <div className="w-8/12">
                                                        <p className="mini-title animate__animated animate__slideInLeft font-extrabold">{acct_details.account_name}</p>
                                                    </div>
                                                </div>
                                                <div className="-mx-4 flex justify-between">
                                                    <div className="w-4/12 px-2">
                                                        <p className="mini-title animate__animated animate__slideInLeft">Account Number:</p>
                                                    </div>
                                                    <div className="w-8/12">
                                                        <p className="mini-title font-extrabold animate__animated animate__slideInLeft">{acct_details.account_number}</p>
                                                    </div>
                                                </div>
                                                <div className="-mx-4 flex justify-between">
                                                    <div className="w-4/12 px-2">
                                                        <p className="mini-title animate__animated animate__slideInLeft">International Routing (SWIFT-BIC) Code:</p>
                                                    </div>
                                                    <div className="w-8/12">
                                                        <p className="mini-title animate__animated animate__slideInLeft font-extrabold">{acct_details.routing_code}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
