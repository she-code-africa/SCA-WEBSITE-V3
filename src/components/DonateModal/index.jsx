                    ...
                    <div className="relative bg-white rounded-lg shadow modal-body mt-5">
                        ...
                        <div className="modal-body p-4">
                            <div className="flex justify-between">
                                ...
                                <div>
                                    <button className="box filter-button" data-filter="wire" onClick={() => displayTransferDets()}>
                                        <h5>Wire Transfer</h5>
                                    </button>
                                </div>
                                {/* <div>
                                        ...
                                        accountInfo.map(({ heading, sub, acct_details }, index) => (
                                            <div key={index}>
                                                <div className="filter wire" >
                                                    <h5 className="text-center animate__animated animate__zoomIn"><b>{heading}</b><br /><span>{sub}</span></h5>
                                                    <div className="acct-details">
                                                        <div className="-mx-4 flex justify-between">
                                                            <div className="w-4/12 px-2 inline">
                                                                <p className="mini-title animate__animated animate__zoomIn">Bank Name:</p>
                                                            </div>
                                                            <div className="w-8/12 inline">
                                                                <p className="mini-title animate__animated animate__zoomIn font-extrabold">{acct_details.bank_name}</p>
                                                            </div>
                                                        </div>
                                                        <div className="-mx-4 flex justify-between">
                                                            <div className="w-4/12 px-2">
                                                                <p className="mini-title animate__animated animate__zoomIn">Bank Account Name:</p>
                                                            </div>
                                                            <div className="w-8/12">
                                                                <p className="mini-title animate__animated animate__zoomIn font-extrabold">{acct_details.account_name}</p>
                                                            </div>
                                                        </div>
                                                        <div className="-mx-4 flex justify-between">
                                                            <div className="w-4/12 px-2">
                                                                <p className="mini-title animate__animated animate__zoomIn">Account Number:</p>
                                                            </div>
                                                            <div className="w-8/12">
                                                                <p className="mini-title font-extrabold animate__animated animate__zoomIn">{acct_details.account_number}</p>
                                                            </div>
                                                        </div>
                                                        <div className="-mx-4 flex justify-between">
                                                            <div className="w-4/12 px-2">
                                                                <p className="mini-title animate__animated animate__zoomIn">International Routing (SWIFT-BIC) Code:</p>
                                                            </div>
                                                            <div className="w-8/12">
                                                                <p className="mini-title animate__animated animate__zoomIn font-extrabold">{acct_details.routing_code}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
