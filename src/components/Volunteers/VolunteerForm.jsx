...
const VolunteerForm = ({
  ...
  return (
    <dialog
      ref={modal}
      className={`backdrop:bg-black backdrop:bg-opacity-80 bg-transparent box-border animate__animated animate__faster ${animatedClass} md:pt-32 justify-center items-center md:w-9/12 w-full mx-auto  ${
        ...
        <section className="bg-white text-[#2D2D2D] h-auto rounded-3xl md:p-7 p-4">
          ...
          <div>
            ...
            >
              ...
              <div>
                <label className="block" htmlFor="resumeLink">
                  Resume Url
                </label>
                <input
                  type="url"
                  ...
                  value={formValue.resumeLink}
                  required
                />
              </div>
              <div>
                <label className="block" htmlFor="portfolioLink">
                  Portfolio (optional)
                </label>
                <input
                  type="url"
