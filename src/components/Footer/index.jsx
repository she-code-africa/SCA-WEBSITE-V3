            ...
            <div className="grid md:grid-cols-4 text-left xs:grid-row-4 md:grid-row-1">
                ...
                <div className="col-span-3 grid md:grid-cols-3 items-start">
                    <div className="">
                        ...
                        <Link to="/partner" className="block mb-5 mt-8 hover:text-primary-main-pink">Partner With Us</Link>
                        <Link to="/donate" className="block mb-5 hover:text-primary-main-pink">Make A Donation</Link>
                        <Link to="/chapters" className="block mb-5 hover:text-primary-main-pink">Start An S.C.A Chapter</Link>
                        <Link to="/chapters" className="block mb-5 hover:text-primary-main-pink">Summit</Link>
                        <div className="relative">
                              <button className="mb-5 flex gap-x-2 items-center hover:text-primary-main-pink" onClick={() => { setOpenCaret(!openCaret) }}>
                            ...
                            {openCaret && (
                                <ul className="bg-white shadow-[0px_0px_8px_2px_rgba(0,0,0,0.20)] w-40 px-2 py-3 rounded absolute">
                                    <li className="hover:bg-gray-200 p-2"><a href="https://drive.google.com/file/d/1ec-yUaFUp7VZgo-1DK87ZQBCYpgi6LpC/view?usp=sharing" target="_blank" rel="noreferrer">2022</a></li>
                                    <li className="hover:bg-gray-200 p-2"><a href="https://drive.google.com/file/d/1u7s0cvaCCjOC2C6iIpOJkvB-sjkGrf_y/view?usp=sharing" target="_blank" rel="noreferrer">2021</a></li>
                                </ul>
                            )}
                        </div>
                    </div>
                    <div className="">
                        ...
                        <Link to="/team" className="block mb-5 hover:text-primary-main-pink mt-8"> Meet The Team</Link>
                        <Link to="/faq" className="block mb-5 hover:text-primary-main-pink">FAQ</Link>
                        <Link to="/code-of-conduct" className="block mb-5 hover:text-primary-main-pink">Code of Conduct</Link>
                        <Link to="/privacy" className="block mb-5 hover:text-primary-main-pink">Privacy Policy</Link>
                        <Link to="/terms" className="block mb-5 hover:text-primary-main-pink">Terms and Condition</Link>
                    </div>
                    <div>
