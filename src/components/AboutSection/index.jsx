...
const AboutSection = () => {
  return (
    <section className="flex sm:justify-end clear-both">
      <div className="flex flex-col sm:flex-row about_section px-6 md:justify-end">
        ...
        <div className="col-span-9">
          <p className="sub-text text-center">
            We are a non-profit organisation focused on celebrating and empowering young girls and
          ...
          <div className="about_values">
            ...
            <div>
              ...
              <h4>Mission</h4>
              <p>
                To build a community that embodies technical growth, networking, mentorship and
                visibility amongst all level career roles in Technology.
              </p>
            </div>
            <div>
