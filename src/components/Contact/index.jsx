  ...
  return (
    <div className="md:container mx-auto p-4 md:px-10 xl:px-20 my-20 md:my-28 lg:my-32">
      <div className="flex justify-center">
        {mutation.isError && showMessage ? (
          <div className="flex md:w-6/12 justify-between items-center p-3 bg-pink-600 text-white rounded-lg">
            <p className="mb-0 font-bold">
              There was an error! Message could not be sent. Please try again
            </p>
            <button
              onClick={closeMessage}
              className="font-medium border-2 border-white w-10 h-10 rounded-full text-xl">
              X
            </button>
          </div>
        ) : null}

        {mutation.isSuccess && showMessage ? (
          <div className="flex md:w-6/12 justify-between items-center p-3 bg-green-600 text-white rounded-lg">
            <p className="mb-0 font-bold">
              Thank you for your message! We&apos;ll be in touch with you soon
            </p>
            <button
              onClick={closeMessage}
              className="font-medium border-2 border-white w-10 h-10 rounded-full text-xl focus:outline-2 ">
              X
            </button>
          </div>
        ) : null}
      ...
      <form
        ...
        <div className="sm:flex flex-col sm:flex-row sm:gap-x-16 xl:gap-x-28">
          <div className="">
            <div className="my-8">
              <label className="block text-xl text-left mb-3" htmlFor="fullName">
                Full Name
              </label>
              <input
