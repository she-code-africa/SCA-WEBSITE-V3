...
export const membershipFaq = [
  ...
  },
  {
    ...
    content: (
      <>
        You can join any She Code Africa city chapter or campus chapter nearest you. Each local
        community has regular events for women-in-tech to further enhance their technical skills and
        leadership skills. You can also follow us on
        <a
          href="https://www.instagram.com/shecodeafrica"
          target="_blank"
          style={{ color: '#6D033F' }}
...
export const programsFaq = [
  {
    ...
    content: (
      <>
        Visit our events page to find out more about this Yes, our offline and online events are
        free. Check our past and present{' '}
  ...
  },
  {
    ...
    content: (
      <>
        You can sign up to be a Mentor /mentee when applications for the next cohort roll out. Visit{' '}
        <Link to={paths.events} style={{ color: '#6D033F' }}>
          {' '}
          here{' '}
        </Link>
        to learn more about this program and when applications for a new cohort kicks off.
      </>
    )
  }
];
...
export const onlineCoursesList = [
  {
    id: 0,
    description: 'Master of Molecular Science & Software Engineering Online Degree Program',
