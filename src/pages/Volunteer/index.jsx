          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-7">
                <span className="inline-block bg-[#FFB8E04D] text-Primary-Magenta rounded-full px-5 py-[10px] text-base sm:text-2xl font-medium mb-6">
                  Volunteer Stories
                </span>
                ...
                <div className="space-y-16">
                  ...
                  <div className="">
                    <div className="pl-0 sm:pl-6 sm:border-l-4 border-SCA-Lavender">
                      <p className="text-2xl sm:text-xl italic font-light text-black leading-relaxed mb-4">
                      ...
                      <div>
                        <div className="font-bold text-xl sm:text-lg text-black">Jane Doe</div>
