      ...
      >
        ...
        <div className="w-11/12 mx-auto my-10">
          <div className="privacy-intro">
            <p>
              She Code Africa (We) are committed to protecting and respecting
              your privacy. This policy (together with our Website Terms and
              Conditions and any other documents referred to on it) sets out the
              basis on which any personal data we collect from you, or that you
              provide to us, will be collected and processed by us. You may
              carefully take a look at the following to understand how we would
              use/treat your personal data.
            </p>
            <p>
              Our data use and protection policy is in consonance with The
              General Data Protection Regulation (EU) 2016/679 (GDPR) and the
              Nigeria Data Protection Regulation 2019. (NITDA Regulations)
            </p>
            <p>The data controller is She Code Africa.</p>
            <p>
              You reserve every right to make a complaint at any time to the
              National Information Technology Development Agency (NITDA).
              However, we would appreciate the chance to deal with your concerns
              before you approach NITDA, so please do well to contact us in the
              first instance.
            </p>
          </div>
          ...
          <div className="donation-faq">
            <h3 className="text-primary-color font-weight-bolder text-2xl">
              <span className="sub_ol">1.</span> INFORMATION WE MAY COLLECT FROM
              YOU:
            </h3>
            <p>We may collect and process the following data about you:</p>
            <ol className="list-decimal pl-10">
              <li>
                <b>Contact Data:</b> This is information such as your name,
                email address and telephone number which we collect when you
                contact us by email, subscribe to any of our newsletters, use
                our services, including news or which we collect via our
                interaction with you (for example from business cards).
              </li>
              <li>
                <b>Profile Data: </b> This is information such as the
                organization you work for, your job title and role, the country
                you are based in and your area of expertise which we collect
                when we come in contact with you.
              </li>
              <li>
                <b>Application Information: </b>This is information such as your
                country of citizenship, past and present employment details,
                home address and contact details and education history, which we
                collect when you apply to attend our training courses or apply
                for any of our services which at the time of drafting this
                policy may not be in existence.
              </li>
              <li>
                ...
                use our Sites, subscribing to any of our Services, posting
              ...
              <li>
                We may also ask you to complete feedback questionnaires or
                surveys that we use for research purposes, although you do not
                have to respond to them.
              </li>
              <li>Details of the Services that you use on our sites.</li>
              <li>
                Details of your visits to our sites including, but not limited
          ...
          <div className="donation-faq">
            <h3 className="text-primary-color font-weight-bolder text-2xl">
              <span className="sub_ol">2.</span> IP ADDRESSES:
            </h3>
            <p>
          ...
          <div className="donation-faq">
            <h3 className="text-primary-color font-weight-bolder text-2xl">
              <span className="sub_ol">3.</span>WHERE WE STORE YOUR PERSONAL
              DATA:
            </h3>
            <p>
              In view of our coverage, the data that we collect from you may not
              be stored in just a country. It could be stored in more than one
              country of Africa. It may not be processed by staff of She Code
              Africa operating only in Africa. By submitting your personal data,
              you agree to this transfer, storing or processing, provided such
              transfer, storing or processing comply with the NITDA Regulations
              2019 and such other regulations as shall from time to time be
              released by the relevant authorities. We will take all steps
            ...
            <p>
              ...
              which enables you to access certain parts of our sites, you are
            ...
            <p>
              ...
              transmitted to our sites; any transmission is at your own risk.
          ...
          <div className="donation-faq">
            <h3 className="text-primary-color font-weight-bolder text-2xl">
              <span className="sub_ol">4.</span>USES MADE OF THE INFORMATION:
            </h3>
            <p>We use information held about you in the following ways:</p>
            <ol className="list-decimal pl-10">
              <li>
                <b>Administration: </b> We may use the personal information we
                collect about you to contact you in response to your queries and
                to provide you with the services you have subscribed to. For
                example, newsletters or news alerts or brokering contacts
                through She Code Africa.
              </li>
              <li>
                <b>Consider Applications: </b> We may use the personal
                information we collect about you to consider your
                applications/submissions on She Code Africa.
              </li>
              <li>
                <b>Communications: </b>We may use personal information we
                collect about you to contact you by e-mail, post or telephone
                with information about the organisation and events that might be
                of interest to you. You can opt out of receiving these
                communications at any point by contacting
                info@shecodeafrica.org.
              </li>
              <li>
                <b>Internal Statistical Analysis: </b>We may use the personal
                information we collect about you to facilitate internal
                statistical analysis, for example to determine the number of
                people using a particular service from a specific country or
                region. We have a policy of anonymizing the information where
                possible.
              </li>
              <li>
                <b>Optimization: </b>To ensure that news and content from our
                sites are presented in the most effective manner for you and for
                your computer.
              </li>
              <li>
                To carry out our obligations to perform the services arising
                from any agreements entered into between you and us or to allow
                you to participate in interactive features of our service, when
                you choose to do so.
              </li>
          ...
          <div className="donation-faq">
            ...
            <ol className="list-decimal pl-10">
              <li>
                If the organisation is transferred to a third party, in which
                case personal data held by it about its partners will be one of
                the transferred assets.
              </li>
              <li>
                If we are under a duty to disclose or share your personal data
                in order to comply with any legal obligation, or in order to
                enforce or apply our website Terms and Conditions and other
                agreements; or to protect the rights, property, or safety of the
                organisation, our partners, or others. This includes exchanging
                information with other companies and organizations for the
                purposes of fraud protection and risk reduction.
              </li>
          ...
          <div className="donation-faq">
            ...
            <ol className="list-decimal pl-10">
              ...
              <li>
                ...
                reason for us continuing to hold same. You also have the right
            ...
            <p>
              In case of any questions regarding our privacy practices, if you
              would like to execute your rights or would like to submit a
              complaint please contact info@shecodeafrica.org.
            </p>
            <p>
