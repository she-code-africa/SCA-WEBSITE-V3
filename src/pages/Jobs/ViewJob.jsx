    ...
    <>
        ...
        <div className="container mx-auto px-4 md:px-20 job-details-container">
            <section className="jobs">
                ...
                <div className="role">
                    <h3 className="title text-[24px]">{job.title}{" "}<span className="jobType">{`(${job.job_type})`}</span> </h3>
                    <p className="org">{job.company} {", "} {job.location}</p>
                </div>
                ...
                <div className="row">
                    <div className="col-sm-12 grid-container margin-top-2r">
                        ...
                        <div className="salary-range">
                            ...
                            <p className="__jobdeets_body">{job.currency} {job.salary_range} </p>
                        </div>
                    </div>
                </div>
                <div>
