    ...
    <>
      ...
      <main>
        ...
        <motion.section
          ...
          viewport={{ once: true }}
          variants={fadeUp}
          className="border border-SCA-Apricote bg-[#FFF88F33] rounded-[30px] max-w-[62.903rem] mx-4 sm:mx-auto flex flex-col sm:flex-row items-center justify-center gap-6 p-6 sm:p-[45px] mt-10 sm:mt-16"
        >
          <FontAwesomeIcon
