...
const Initiatives = () => {
  ...
  return (
    <div>
      ...
      <InitiativeCard
        title="STEM-A-Girl"
        description="Empowering young girls in underserved communities with STEM skills through mentorship, workshops, and scholarships."
        image={require('../../images/initiative/initiativeImg.jpg')}
        status="Ongoing"
        primaryBtn={{ label: "Learn more", href: "#" }}
        secondaryBtn={{ label: "Make donation", href: "#" }}
        bgPattern="pink"
      />
      ...
      <InitiativeCard
        ...
        description="Providing free access to premium courses for African women looking to break into tech or upskill."
        image={require('../../images/initiative/initiativeImg.jpg')}
      ...
      <InitiativeCard
        ...
        description="Connecting women in tech with experienced mentors who can guide them through their career journey."
        image={require('../../images/initiative/initiativeImg.jpg')}
        status="Ongoing"
        primaryBtn={{ label: "Apply now", href: "#" }}
        secondaryBtn={{ label: "Make donation", href: "#" }}
      ...
      <InitiativeCard
        title="Hackathon"
        description="Collaborative events where women developers, designers, and innovators build impactful solutions in teams."
        image={require('../../images/initiative/initiativeImg.jpg')}
        status="Upcoming"
        primaryBtn={{ label: "Apply now", href: "#" }}
        secondaryBtn={{ label: "Make donation", href: "#" }}
      ...
      <InitiativeCard
        ...
        description="A fast-paced bootcamp teaching women essential digital skills to thrive in the modern workforce."
        image={require('../../images/initiative/initiativeImg.jpg')}
        status="Ongoing"
        primaryBtn={{ label: "Apply now", href: "#" }}
        secondaryBtn={{ label: "Make donation", href: "#" }}
