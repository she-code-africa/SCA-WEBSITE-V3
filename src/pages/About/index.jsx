            ...
            <div className="-mx-4 w-full">
              <div className="md:w-6/12 md:inline-block">
                ...
                <p className="about_subtitle">
                  We are a non-profit organization <br /> focused on celebrating and <br />
                  <span className="__shecodegirls">empowering young Girls and Women</span>
                  <br /> in Technology across Africa.
                </p>
              </div>
        ...
        <div className="container mx-auto lg:px-12 clear-both">
          ...
          <section>
            <div className="mx-auto max-w-4xl">
              ...
              <p className="about_topic2 text-center">
                Peep the faces behind the initiatives and impacts here at She Code Africa. These
                wonderful people work behind the scene, everyday to keep our vision working.
              </p>
            </div>
            {teamCall.isLoading ? (
                  ...
                  {teamMembers?.map((member, index) => {
                    return (
                      <ImgCard
                        name={member.name}
                        src={member?.image || ''}
                        role={`${member.isLeader ? 'Lead, ' : ''} ${member.team.name}`}
                        key={index}
                      />
                    );
                  })}
                  <div className="text-center sm:col-span-2 lg:col-start-1 lg:col-span-3">
                    <Link className="btn shecode_button push2" to="/team">
                      {' '}
                      VIEW ALL{' '}
                    </Link>
                  </div>
