      ...
      <main>
        <section className="h-[70vh]">
          <div className="lg:w-6/12 w-11/12 mx-auto flex flex-col items-center justify-center text-[#210D15] h-full">
            ...
            <p className="text-xl text-center">We are a non-profit organization focused on celebrating and <span className="text-[#B70569] font-extrabold">empowering young Girls and Women</span> in Technology across Africa.</p>
          </div>
        </section>
        <section
          ...
          <div className="lg:w-8/12 w-11/12 mx-auto flex flex-col md:flex-row justify-between md:items-center gap-14 md:h-full">
            <article className="md:w-5/12">
              <div className="w-[70px] h-[70px] rounded-full bg-[#FDC0E3] flex justify-center items-center">
                <img src={mission} alt="" className="w-[50px]" role="presentation" />
              </div>
            ...
            <article className="md:w-5/12">
              <div className="w-[70px] h-[70px] rounded-full bg-[#FDC0E3] flex justify-center items-center">
                <img src={vision} alt="" className="w-[50px]" role="presentation" />
              </div>
        ...
        <section className="my-24">
          <h3 className="text-center text-[40px] font-bold my-20">Our Values</h3>
          <ul className="flex md:flex-row flex-col gap-8 2xl:w-9/12 lg:w-10/12 md:w-11/12 mx-auto md:justify-between my-5">
            <li className="flex flex-col items-center">
              <div className="w-[50px] h-[50px] rounded-full bg-[#FDC0E3] flex justify-center items-center my-3">
                <img src={teamwork} alt="" className="w-[30px]" role="presentation" />
              </div>
        ...
        <section className="my-40">
          <h3 className="text-center text-[40px] font-bold mb-11">Members Benefits</h3>
          <div className="2xl:w-9/12 lg:w-9/12 w-11/12 mx-auto">
            <article className="flex flex-col md:flex-row gap-y-5 md:gap-y-0 items-center justify-between my-6 md:my-0">
              <div className="md:w-6/12">
                <h4 className="text-[#210D15] text-4xl font-semibold mb-3">Community Support</h4>
                <p className="text-[#210D15] text-lg">We provide support through our diverse offline and online communities. With amazing programs and initiatives to always keep you engaged, you never run out of network, resources and mentorship.</p>
              </div>
              <img src={community} alt="Lady holding laptop pack" className="object-contain h-[350px]" />
            </article>
            <article className="flex md:flex-row-reverse flex-col gap-y-5 md:gap-y-0 items-center justify-between my-6 md:my-0">
              <div className="md:w-6/12">
                <h4 className="text-[#210D15] text-4xl font-semibold mb-3">Monitored Growth</h4>
                <p className="text-[#210D15] text-lg">We provide resources and monitor your growth every step of the way through regular check-ins to ensure you are hitting your personal and career goals.</p>
              </div>
              <img src={growth} alt="four people smiling" className="object-contain h-[350px]" />
            </article>
            <article className="flex flex-col md:flex-row gap-y-5 md:gap-y-0 items-center justify-between my-6 md:my-0">
              <div className="md:w-6/12">
                <h4 className="text-[#210D15] text-4xl font-semibold mb-3">Professional Guidance</h4>
                <p className="text-[#210D15] text-lg">Through our intensive dedicated Mentorship program and various mentors available on our community platform, you are able to get help and guidance in your learning journey or career field whenever you need it.</p>
              </div>
              <img src={guidance} alt="four people reviewing code" className="object-contain h-[350px]" />
            </article>
            <article className="flex md:flex-row-reverse flex-col gap-y-5 md:gap-y-0 items-center justify-between my-6 md:my-0">
              <div className="md:w-6/12">
                <h4 className="text-[#210D15] text-4xl font-semibold mb-3">Pair Support</h4>
                <p className="text-[#210D15] text-lg">Network and meet with other women in tech in Africa who have walked or are walking in the same path as you are and can relate with your experience while helping you on your journey.</p>
              </div>
              <img src={support} alt="two ladies discussing" className="object-contain h-[350px]" />
            </article>
          </div>
        </section>
