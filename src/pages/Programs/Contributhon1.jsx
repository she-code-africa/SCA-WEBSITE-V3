    ...
    <>
      ...
      <main className="w-11/12 md:w-10/12 mx-auto px-8">
       ...
       <section className="md:flex">
          <div className="mr-32">
            <p class="page_title">Contributhon</p>
            <p class="page_subtitle">
              Contributhon is a virtual open-source boot camp where ladies get the opportunity to work with open source organizations on selected projects with dedicated mentorship.
            ...
            <span class="text-primary-dark-pink text-xl font-semibold block my-10">Fri, 01 Apr, 2022 - Tue, 31 May, 2022</span>
          </div>
       ...
       <div className="text-center my-20">
          <a target="_blank" href="https://bit.ly/contributhonbysca" class="btn shecode_button" rel="noreferrer">Learn More </a>
       </div>
      </main>
    </>
  )
